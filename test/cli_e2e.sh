...
! grep -Fq "$artifacts" "$artifacts/runs/e2e/evidence/CJ-HUMANEVAL-000/index.tsv"
grep -q '^generation.txt[[:space:]]' "$artifacts/runs/e2e/evidence/CJ-HUMANEVAL-000/index.tsv"
